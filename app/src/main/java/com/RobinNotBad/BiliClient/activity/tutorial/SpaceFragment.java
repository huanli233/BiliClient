...
public class SpaceFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        text1.setSpan(new StyleSpan(Typeface.BOLD),7,61, Spanned.SPAN_INCLUSIVE_INCLUSIVE);
        ...
        //多个加粗只能每次new一个StyleSpan
        text2.setSpan(new StyleSpan(Typeface.BOLD),6,15, Spanned.SPAN_INCLUSIVE_INCLUSIVE);
